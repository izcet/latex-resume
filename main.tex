...
\item Problem Solving
  ...
  \begin{tabular}{p{0.58\textwidth} c}
    ...
    \cveventtwo{Security Engineer ~•~ Google}{2022--2024}{Mountain View \color{cvred}}{\bpt
    ...
    \bpt I also identified threats in the android developer ecosystem both on and off Play, and wrote tooling to automate detection and removal of malicious apps and SDK supply chain threats.
    }{logos/google.png} \\
    \cveventtwo{Security Intelligence Engineer ~•~ Lookout}{2018-2022}{Boston \color{cvred}}{
      ...
      \bpt Won first place in the 2021 company-wide \href{https://www.securecodewarrior.com/}{Secure Code Warrior} competition.
    }{logos/lookout2.png} \\
    ...
    \cveventtwo{Instructor ~•~ Code For Fun}{2017--2018}{Fremont \color{cvred}}{
      I've actively engaged more than 40 high school students using python to teach computer science and cybersecurity concepts.
